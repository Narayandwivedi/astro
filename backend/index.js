...
// Middleware
app.use(cors({
  origin: ['https://api.astrosatyaprakash.com', 'https://astrosatyaprakash.com', 'https://www.astrosatyaprakash.com', 'https://astro-admin-nu.vercel.app','http://localhost:5173', 'http://localhost:5174','http://localhost:5175'],
  credentials: true
}));
