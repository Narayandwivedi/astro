          ...
          <div className="absolute top-full mt-2 right-0 bg-white rounded-xl shadow-2xl border border-gray-200 p-4 z-50 min-w-[280px]">
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-green-50 rounded-lg transition-colors group"
              >
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-blue-50 rounded-lg transition-colors group"
              >
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-sky-50 rounded-lg transition-colors group"
              >
                ...
                <span className="text-gray-700 group-hover:text-sky-500 font-medium">Twitter</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-700 group-hover:text-blue-500 font-medium">Telegram</span>
              </button>

              {/* Copy Link */}
              <button
                onClick={handleCopyLink}
                className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-gray-100 rounded-lg transition-colors group border-t border-gray-200 mt-2 pt-3"
              >
